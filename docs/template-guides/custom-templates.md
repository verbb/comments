...
:::tip
Check out the raw templates on [Comment's GitHub](https://github.com/verbb/comments/tree/craft-5/src/templates/_special) - they'll be the most up to date.
:::
...
View these example templates via [GitHub](https://github.com/verbb/comments/tree/craft-5/examples).
