...
Params: - comment – The [CommentModel](/craft-plugins/comments/docs/developers/comment-model) that is about to be saved.
...
Params: - comment – The [CommentModel](/craft-plugins/comments/docs/developers/comment-model) that has been saved.
...
Params: - comment – The [CommentModel](/craft-plugins/comments/docs/developers/comment-model) that is about to be trashed.
...
Params: - comment – The [CommentModel](/craft-plugins/comments/docs/developers/comment-model) that has been trashed.
...
Params: - comment – The [CommentModel](/craft-plugins/comments/docs/developers/comment-model) that is about to be flagged.
...
Params: - comment – The [CommentModel](/craft-plugins/comments/docs/developers/comment-model) that has been flagged.
...
Params: - comment – The [CommentModel](/craft-plugins/comments/docs/developers/comment-model) that is about to be voted on.
...
Params: - comment – The [CommentModel](/craft-plugins/comments/docs/developers/comment-model) that has been voted on.
